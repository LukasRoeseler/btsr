...
(() => {
  ...
  const I18N_EN = {
    ...
    "Automatik, 2,6 s auf 100, Reifen und Tankgewicht wirken zur Hälfte. Die Lenkung ist so direkt wie bei Arcade (120 % des Anschlags bei vollem Stick), in der Bremse ist aber noch Reserve.": "Automatic, 2.6 s to 100, tyres and fuel weight at half effect. The steering is as direct as in Arcade (120 % of the lock at full stick), but there is still reserve in the brakes.",
