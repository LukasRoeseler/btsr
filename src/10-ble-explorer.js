...
(() => {
  ...
  const I18N_EN = {
    ...
    "Dreizehn Messungen an der laufenden App. Sie ersetzen keine Fahrt, aber sie sagen, ob eine Änderung etwas kaputt gemacht hat, das man nicht sofort sieht: eine Physik, die nicht mehr trifft, eine Ideallinie mit einem Sprung, eine Tonschleife mit einer Naht, ein deutscher Satz im englischen Modus.": "Thirteen measurements on the running app. They do not replace a drive, but they say whether a change broke something you would not notice at once: physics that no longer matches, a racing line with a jump, a sound loop with a seam, a German sentence in English mode.",
    ...
    "Ein Knopf, dreizehn Messungen: lädt alles, rechnet die Physik richtig, passt die Linie, sind die Töne heil.": "One button, thirteen measurements: does it all load, is the physics right, does the line fit, are the sounds intact.",
