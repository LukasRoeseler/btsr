...
(() => {
  ...
  const I18N_EN = {
    ...
    "Nur das Aussehen des Cockpit-Schirms – Anzeigen, Tasten und Physik bleiben, wie sie sind. „GT3“ ist die Vorgabe. „Oldschool“ ist Bernstein auf Schwarz mit sichtbaren Pixelzeilen und runden Ecken, wie die Vakuumfluoreszenz-Armaturen der 1980er; „Modern“ ist kühles Weiß auf Anthrazit, flach und scharf, wie die ersten Farb-TFT der 2000er. Die Bedeutungsfarben bleiben in allen drei gleich: der Tankbalken ist grün und der Schaden rot, auch in der Retro-Ansicht – eine Ansicht darf ändern, wie es aussieht, nicht was eine Farbe sagt. Die Voreinstellungen fassen die Ansicht nicht an.": "Only the look of the cockpit screen – readouts, buttons and physics stay as they are. “GT3” is the default. “Oldschool” is amber on black with visible scan lines and rounded corners, like the vacuum-fluorescent instruments of the 1980s; “Modern” is cool white on anthracite, flat and sharp, like the first colour TFTs of the 2000s. The meaning colours stay the same in all three: the fuel bar is green and damage is red, in the retro look as well – a look may change how something appears, not what a colour says. The presets do not touch the look.",
