...
(() => {
  ...
  const I18N_EN = {
    ...
    "Die Rekonstruktion ist nachweislich eine treue Kopie des Original-PDF: Balkenzahl, Höhen auf 0,000 mm und Lücken auf 0,001 mm stimmen überein, und das PDF enthält nachgeprüft keine weiteren Formen. Also ist dieses PDF nicht die Vorlage, die 0x0a erzeugt; die Druckvorlagen haben sich offenbar geändert. Und 0x03 ist zugleich der gemessene Code der Linkskurve.": "The reconstruction is demonstrably a faithful copy of the original PDF: bar count, heights to 0.000 mm and gaps to 0.001 mm all agree, and the PDF has been checked to contain no further shapes. So this PDF is not the master that produces 0x0a; the print masters have evidently changed. And 0x03 is also the measured code of the left curve.",
