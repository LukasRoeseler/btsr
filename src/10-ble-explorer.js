...
(() => {
  ...
  const I18N_EN = {
    ...
    "Ein Verfolger, der 0,9 s dicht dran hängt, setzt auf einer Geraden an: erst zur Seite, dann Schub, dann vorne wieder einordnen. Der Vorausfahrende weicht zur anderen Seite aus – zwei Autos auf 25 cm Bahnbreite brauchen beide Hälften. Klappt es nach 5 s nicht, bricht er ab und wartet 6 s; ohne diesen Abbruch klebte der Verfolger neben dem anderen, bis die Uhr ablief, und genau dort berühren sie sich. In eine Kurve hinein wird nie angesetzt.":
      "A pursuer that has sat close for 0.9 s makes its move on a straight: first to the side, then a push, then tucking back in ahead. The car in front moves to the other side – two cars on 25 cm of track width need both halves. If it has not worked after 5 s it breaks off and waits 6 s; without that break-off the pursuer stuck alongside until the clock ran out, and that is exactly where they touch. A move is never started into a corner.",
    "Abstand halten":
      "Keeping a gap",
